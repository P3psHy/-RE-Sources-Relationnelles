...
public class Utilisateur {
    ...
    private Set<EtreEnRelation> ternaryRelations;

    @ManyToMany
    @JoinTable(name = "AjouterFavoris", joinColumns = @JoinColumn(name = "idUtilisateur"), inverseJoinColumns = @JoinColumn(name = "idRessource"))
    private Set<Ressource> listeRessourceFavoris;
